...
class TimmLitModule(LightningModule):
    def __init__(self,net,optimizer: torch.optim.Optimizer,scheduler: torch.optim.lr_scheduler,num_classes=10):
        super().__init__()
    ...
    def model_step(self, batch: Any):
        """
        This is common function for step- Both training and validation 
        """
        image, label = batch
